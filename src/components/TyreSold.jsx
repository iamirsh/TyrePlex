...
const TyreSold = () => {
  ...
  const items = ["Apollo", "Bedrock", "Birla", "CEAT", "Bringstone", "JK Tyre", "MRF"];
  ...
  return (
    <>
      ...
      {/* Main Content */}
      <div className="container my-4" style={{ backgroundColor: "#f8f9fa", padding: "20px 0" }}>
        <Container>
          ...
          <div className="d-flex justify-content-end gap-4">
            ...
            >
              ...
              <Dropdown.Menu show={showDropdown} className="w-100 dropdown-menu-custom">
                <FormControl
                  type="text"
                  placeholder="Search..."
                  className="mb-2"
          ...
          {/* Cards Display */}
          <Row>
            {initialTyreSoldByDealers.slice(0, visibleCount).map((tyre, index) => (
                  ...
                  <Card.Body>
                    ...
                    <div className="position-absolute top-0 end-0">
                      <span className="d-flex align-items-center bg-warning-subtle text-dark rounded-2 px-2">
                        <i className="bi bi-shield-fill-check me-2"></i>5 Year Warranty
                      </span>
                    </div>
                    ...
                    <div className="d-flex align-items-start">
                      <div className="pe-3 pt-3">
                        ...
                        <Card.Text className="text-secondary">145/80 R12</Card.Text>
                        ...
                        <Card.Text className="text-success">Offer available</Card.Text>
                        <Card.Text className="text-secondary">Tubeless</Card.Text>
                      </div>
                    </div>
                  </Card.Body>
                </Card>
